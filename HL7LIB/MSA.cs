...
namespace HL7LIB.ConcretcompositeType
{
    ...
    public class PV1 : compositeSegment
    {
        public PV1(compositeType parent, string name) : base(parent, name)
        {
            ...
            data[1] = new IS("PatientClass");
            data[2] = new PL(this,"AssignedPatientLocation");
            data[3] = new IS("AdmissionType");
            data[4] = new CX(this, "PreadmitNumber");
            data[5] = new PL(this, "PriorPatientLocation");
            data[6] = new XCN(this, "AttendingDoctor");
            data[7] = new XCN(this, "ReferringDoctor");
            data[8] = new XCN(this, "ConsultingDoctor");
            data[9] = new IS("HospitalService");
            data[10] = new PL(this, "TemporaryLocation");
            data[11] = new IS("PreadmitTestIndicator");
            data[12] = new IS("ReadmissionIndicator");
            data[13] = new IS("AdmitSource");
            data[14] = new IS("AmbulatoryStatus");
            data[15] = new IS("VIPIndicator");
            data[16] = new XCN(this, "this,AdmittingDoctor");
            data[17] = new IS("PatientType");
            data[18] = new CX(this, "VisitNumber");
            data[19] = new FC(this, "FinancialClass");
            data[20] = new IS("ChargePriceIndicator");
            data[21] = new IS("CourtesyCode");
            data[22] = new IS("CreditRating");
            data[23] = new IS("ContractCode");
            data[24] = new DT("ContractEffectiveDate");
            data[25] = new NM("ContractAmount");
            data[26] = new NM("ContractPeriod");
            data[27] = new IS("InterestCode");
            data[28] = new IS("TransfertoBadDebtCode");
            data[29] = new DT("TransfertoBadDebtDate");
            data[30] = new IS("BadDebtAgencyCode");
            data[31] = new NM("BadDebtTransferAmount");
            data[32] = new NM("BadDebtRecoveryAmount");
            data[33] = new IS("DeleteAccountIndicator");
            data[34] = new DT("DeleteAccountDate");
            data[35] = new IS("DischargeDisposition");
            data[36] = new DLD(this, "DischargedtoLocation");
            data[37] = new CE(this, "DietType");
            data[38] = new IS("ServicingFacility");
            data[39] = new IS("BedStatus");
            data[40] = new IS("AccountStatus");
            data[41] = new PL(this, "PendingLocation");
            data[42] = new PL(this, "PriorTemporaryLocation");
            data[43] = new TS("AdmitDateOrTime");
            data[44] = new TS("DischargeDateOrTime");
            data[45] = new NM("CurrentPatientBalance");
            data[46] = new NM("TotalCharges");
            data[47] = new NM("TotalAdjustments");
            data[48] = new NM("TotalPayments");
            data[49] = new CX(this, "AlternateVisitID");
            data[50] = new IS("VisitIndicator");
            data[51] = new XCN(this, "OtherHealthcareProvider");
        }
        public SI SetIDPV1 { get { return data[0] as SI; } set { data[0] = value; } }
        public IS PatientClass { get { return data[1] as IS; } set { data[1] = value; } }
        public PL AssignedPatientLocation { get { return data[2] as PL; } set { data[2] = value; } }
        public IS AdmissionType { get { return data[3] as IS; } set { data[3] = value; } }
        public CX PreadmitNumber { get { return data[4] as CX; } set { data[4] = value; } }
        public PL PriorPatientLocation { get { return data[5] as PL; } set { data[5] = value; } }
        public XCN AttendingDoctor { get { return data[6] as XCN; } set { data[6] = value; } }
        public XCN ReferringDoctor { get { return data[7] as XCN; } set { data[7] = value; } }
        public XCN ConsultingDoctor { get { return data[8] as XCN; } set { data[8] = value; } }
        public IS HospitalService { get { return data[9] as IS; } set { data[9] = value; } }
        public PL TemporaryLocation { get { return data[10] as PL; } set { data[10] = value; } }
        public IS PreadmitTestIndicator { get { return data[11] as IS; } set { data[11] = value; } }
        public IS ReadmissionIndicator { get { return data[12] as IS; } set { data[12] = value; } }
        public IS AdmitSource { get { return data[13] as IS; } set { data[13] = value; } }
        public IS AmbulatoryStatus { get { return data[14] as IS; } set { data[14] = value; } }
        public IS VIPIndicator { get { return data[15] as IS; } set { data[15] = value; } }
        public XCN AdmittingDoctor { get { return data[16] as XCN; } set { data[16] = value; } }
        public IS PatientType { get { return data[17] as IS; } set { data[17] = value; } }
        public CX VisitNumber { get { return data[18] as CX; } set { data[18] = value; } }
        public FC FinancialClass { get { return data[19] as FC; } set { data[19] = value; } }
        public IS ChargePriceIndicator { get { return data[20] as IS; } set { data[20] = value; } }
        public IS CourtesyCode { get { return data[21] as IS; } set { data[21] = value; } }
        public IS CreditRating { get { return data[22] as IS; } set { data[22] = value; } }
        public IS ContractCode { get { return data[23] as IS; } set { data[23] = value; } }
        public DT ContractEffectiveDate { get { return data[24] as DT; } set { data[24] = value; } }
        public NM ContractAmount { get { return data[25] as NM; } set { data[25] = value; } }
        public NM ContractPeriod { get { return data[26] as NM; } set { data[26] = value; } }
        public IS InterestCode { get { return data[27] as IS; } set { data[27] = value; } }
        public IS TransfertoBadDebtCode { get { return data[28] as IS; } set { data[28] = value; } }
        public DT TransfertoBadDebtDate { get { return data[29] as DT; } set { data[29] = value; } }
        public IS BadDebtAgencyCode { get { return data[30] as IS; } set { data[30] = value; } }
        public NM BadDebtTransferAmount { get { return data[31] as NM; } set { data[31] = value; } }
        public NM BadDebtRecoveryAmount { get { return data[32] as NM; } set { data[32] = value; } }
        public IS DeleteAccountIndicator { get { return data[33] as IS; } set { data[33] = value; } }
        public DT DeleteAccountDate { get { return data[34] as DT; } set { data[34] = value; } }
        public IS DischargeDisposition { get { return data[35] as IS; } set { data[35] = value; } }
        public DLD DischargedtoLocation { get { return data[36] as DLD; } set { data[36] = value; } }
        public CE DietType { get { return data[37] as CE; } set { data[37] = value; } }
        public IS ServicingFacility { get { return data[38] as IS; } set { data[38] = value; } }
        public IS BedStatus { get { return data[39] as IS; } set { data[39] = value; } }
        public IS AccountStatus { get { return data[40] as IS; } set { data[40] = value; } }
        public PL PendingLocation { get { return data[41] as PL; } set { data[41] = value; } }
        public PL PriorTemporaryLocation { get { return data[42] as PL; } set { data[42] = value; } }
        public TS AdmitDateOrTime { get { return data[43] as TS; } set { data[43] = value; } }
        public TS DischargeDateOrTime { get { return data[44] as TS; } set { data[44] = value; } }
        public NM CurrentPatientBalance { get { return data[45] as NM; } set { data[45] = value; } }
        public NM TotalCharges { get { return data[46] as NM; } set { data[46] = value; } }
        public NM TotalAdjustments { get { return data[47] as NM; } set { data[47] = value; } }
        public NM TotalPayments { get { return data[48] as NM; } set { data[48] = value; } }
        public CX AlternateVisitID { get { return data[49] as CX; } set { data[49] = value; } }
        public IS VisitIndicator { get { return data[50] as IS; } set { data[50] = value; } }
        public XCN OtherHealthcareProvider { get { return data[51] as XCN; } set { data[51] = value; } }
    }
    /// <summary>
